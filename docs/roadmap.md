...
3. **D2 — targeted cleanup** — delete confirmed dead RPCs/modules; delete tiny-model service and record its SHA. **Mostly done 2026-08-02** (`309c386`, `ebdc0f2`, `c8ed045`, `45cb0ff`); `apply_tdp` is the one item still open, see **D2-TDP** below.
