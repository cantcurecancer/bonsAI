...
- [ ] **PICKER-REORDER-01** Try order: one press of Down must move the *highlight*, not the model. **Currently moves the model and loses the ring** — blocked on D36, re-run on both the text and vision lists once it lands
