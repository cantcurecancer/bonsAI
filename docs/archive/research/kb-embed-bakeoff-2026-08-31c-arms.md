...
- Holdout arm verdict: No separation on holdout top-3: RRF 76.1% [67.4, 84.8] vs keyword 70.7% [60.9, 80.4] — intervals overlap, so these fixtures (n=92) cannot tell the arms apart. Not a tie; an unresolved question.
...
**Holdout verdict:** No separation on holdout top-3: RRF 76.1% [67.4, 84.8] vs keyword 70.7% [60.9, 80.4] — intervals overlap, so these fixtures (n=92) cannot tell the arms apart. Not a tie; an unresolved question.
